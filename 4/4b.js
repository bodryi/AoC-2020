...
const HEX_COLOR_REGEXP = /^#[a-f,0-9]{6}$/;
...
const REQUIRED_FIELDS = [
  ...
  { name: 'hcl', validationFn: (value) => HEX_COLOR_REGEXP.test(value) },
  {
    name: 'ecl',
    validationFn: (value) => !!EYE_COLORS.find((c) => c === value),
  },
  { name: 'pid', validationFn: (value) => PASSPORT_ID_REGEXP.test(value) },
];
